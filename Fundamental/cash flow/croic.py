...
if croic_company > croic_industry_avg:
    print("The company's CROIC is above the industry average, indicating efficient cash generation relative to peers.")
elif croic_company == croic_industry_avg:
    print("The company's CROIC is on par with the industry average. It's generating cash returns similar to its peers.")
else:
    print("The company's CROIC is below the industry average. It may not be as efficient in cash generation compared to its peers.")
