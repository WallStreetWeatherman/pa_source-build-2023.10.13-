...
if quick_ratio >= industry_avg_quick_ratio:
    print("The company has a strong Quick Ratio compared to the industry average.")
else:
    print("The company's Quick Ratio is below the industry average, indicating potential liquidity concerns.")

if debt_to_equity_ratio <= industry_avg_debt_to_equity_ratio:
    print("The company has a reasonable Debt-to-Equity Ratio compared to the industry average.")
else:
    print("The company's Debt-to-Equity Ratio is higher than the industry average, suggesting increased financial risk.")
