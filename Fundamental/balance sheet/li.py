...
# Compare company's Liquidity Index with industry average
if company_liquidity_index > industry_average_liquidity_index:
    print("\nThe company's liquidity position is better than the industry average.")
elif company_liquidity_index < industry_average_liquidity_index:
    print("\nThe company's liquidity position is weaker than the industry average.")
else:
    print("\nThe company's liquidity position is in line with the industry average.")