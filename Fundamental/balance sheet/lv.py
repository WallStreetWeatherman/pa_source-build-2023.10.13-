...
if liquidation_value > industry_liquidation_value:
    print(f"The company's liquidation value is above the industry average, indicating a relatively strong position in tangible assets.")
else:
    print(f"The company's liquidation value is below the industry average, suggesting caution for investors emphasizing tangible asset backing.")
