...
# Compare company's Net Borrowing with industry average
if company_net_borrowing > industry_average_net_borrowing:
    print("\nThe company's Net Borrowing is higher than the industry average.")
elif company_net_borrowing < industry_average_net_borrowing:
    print("\nThe company's Net Borrowing is lower than the industry average.")
else:
    print("\nThe company's Net Borrowing aligns with the industry average.")